...
const prediction_url = "https://0271-186-29-180-0.ngrok-free.app/prediction-llm";
...
return Functions.encodeUint256(Math.round(prediction * 100));`);
  ...
  const [config, setConfig] = useState<Config>({
    consumerAddress: "0x5abE77Ba2aE8918bfD96e2e382d5f213f10D39fA",
    subscriptionId: "3",
  ...
  const writeContractAsyncWithParams = async () => {
    ...
    const donIdBytes32 = keccak256(toHex(SEPOLIA_CONFIG.donId));

    return writeContractAsync({
      address: "0xC62834fb7d07d9cbFae7A024917f4dA6e094B4B1",
        ...
        <div className="space-y-6">
                ...
                <div className="p-3 bg-green-100 border border-green-300 rounded-md">
                  ...
                  {result.type === "update" && result.transactionHash && (
                    <div className="text-sm text-green-600">
                      ...
                      <br />
                      <a
                        href={`${SEPOLIA_CONFIG.explorerUrl}/tx/${result.transactionHash}`}
                        target="_blank"
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="text-sm text-blue-600 space-y-1">
              <div>
                <strong>Red:</strong> Arbitrum Sepolia
              </div>
              <div>
                <strong>Router:</strong> {SEPOLIA_CONFIG.routerAddress}
              </div>
              <div>
                <strong>DON ID:</strong> {SEPOLIA_CONFIG.donId}
              </div>
              <div>
                <strong>Explorer:</strong> {SEPOLIA_CONFIG.explorerUrl}
              </div>
              <div>
